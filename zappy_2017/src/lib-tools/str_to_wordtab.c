...
static bool malloc_words(char **tab, const char *str, char delimiter)
{
	int n_word = 0;
	int nb_letters = 0;
	int i = 0;
...
static void fill_tab(char **tab, const char *str, char delimiter)
{
	int n_word = 0;
	int n_letter = 0;
	int i = 0;
...
char **str_to_wordtab(const char *str, char delimiter)
{
	char **tab = NULL;
	int nb_words = 0;
